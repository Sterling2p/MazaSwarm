...
var popover = renderer.create([
    '<div class="note-popover in popover">',
    '  <div class="arrow"/>',
...
var checkbox = renderer.create('<label class="mt-20 custom-checkbox"></label>', function ($node, options) {
    if (options.id) {
        $node.attr('for', options.id);
    }
    $node.html([
		'<div class="form-group-check custom-check">',
		' <input role="checkbox" type="checkbox" class="form-group-check__checkbox"' + (options.id ? ' id="' + options.id + '"' : ''),
        (options.checked ? ' checked' : ''),
        ' aria-checked="' + (options.checked ? 'true' : 'false') + '"/>',
        '<label  class="form-group-check__label"' + (options.id ? ' id="' + options.id + '"' : '')+'>' + (options.text ? options.text : '') + '</label>',
		'</div>',
    ].join(''));
});
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input class="note-link-url form-control note-form-control note-input" type="url" value="https://" />',
            '</div>',
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<input class="note-image-input note-form-control note-input custom-file" ',
